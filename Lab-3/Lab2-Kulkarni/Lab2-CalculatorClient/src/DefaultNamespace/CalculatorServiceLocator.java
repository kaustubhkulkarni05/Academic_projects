...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/Lab2-Calculator/services/Calculator";
    ...
    public DefaultNamespace.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.CalculatorSoapBindingStub _stub = new DefaultNamespace.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.CalculatorSoapBindingStub _stub = new DefaultNamespace.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "Calculator"));
        }
