...
//		CategoryName output = new CategoryName();
		...
		CategoryDisplay output = new CategoryDisplay();
		 ...
		 try{			
			 	String oldcategoryName = request.getParameter("old_category_name");
			 	...
			 	adminOutput = proxy.updateCategory(oldcategoryName, categoryName, categoryDescription);
			 	
			 	if(output.getErrorMessage() == null){
				    RequestDispatcher view=request.getRequestDispatcher("updateCategoryValidation.jsp");
