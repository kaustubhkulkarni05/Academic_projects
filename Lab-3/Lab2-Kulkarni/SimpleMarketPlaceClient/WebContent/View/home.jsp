...
<%@page import="Connection.ServiceSoapBindingStub"%>
<%@ page import ="DAO.*,
...
<%
 ...
 URL endpoint =
     new URL("http://localhost:8080/SimpleMarketPlace/services/Service");

 //Replace the servername and context according to your server settings
 ServiceSoapBindingStub stub =
     new ServiceSoapBindingStub(endpoint,null);
%>
